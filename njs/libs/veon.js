...
var to_rad_factor = Math.PI / 180;
var to_deg_factor = 180 / Math.PI;


var getPointsDistance = function(lat1, lon1, lat2, lon2) {
	lat1 = lat1 * to_rad_factor; lon1 = lon1 * to_rad_factor;
	lat2 = lat2 * to_rad_factor; lon2 = lon2 * to_rad_factor;
...
var getPointsDistanceM =  function(p1, p2) {
	return getPointsDistance(p1[0], p1[1], p2[0], p2[1]);
};
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
var veon = window.veon = {
  getPointsDistance: getPointsDistance,
  getPointsDistanceM: getPointsDistanceM,
  LatLon: LatLon,
  Geo: Geo
};
return veon;
